...
import star from '../../assets/images/video/star.png';
import shape from '../../assets/images/video/shape.png';
        ...
        <div className="grid grid-cols-12 gap-[30px] items-center">
          <div className="col-span-12 lg:col-span-6 relative">
            <div className="mb-5 lg:mb-0 max-w-[450px]">
              ...
              <h2 className="font-lora text-primary text-[24px] sm:text-[30px] leading-[1.277] xl:text-xl mb-[10px] font-medium">
