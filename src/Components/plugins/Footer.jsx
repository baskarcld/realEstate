...
const Footer = () => {
  return (
    <footer
      className="footer bg-[#ECFAF7] pt-[80px] lg:pt-[200px] pb-30 md:pb-[80px] lg:pb-[110px] font-normal bg-no-repeat"
      style={{ backgroundImage: 'url("assets/images/footer/pattern.png")' }}
    >
      <div className="container">
        <div className="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
          <div className="col-span-12 sm:col-span-6 lg:col-span-4 mb-[30px]">
            ...
            <p className="mb-[5px] xl:mb-[40px] max-w-[270px]">
          ...
          <div className="col-span-12 sm:col-span-6 lg:col-span-3 mb-[30px]">
            <h3 className="font-lora font-normal text-[22px] leading-[1.222] text-primary mb-[20px] lg:mb-[30px]">
          ...
          <div className="col-span-12 sm:col-span-6 lg:col-span-2 mb-[30px]">
            ...
            <ul className="inline-flex items-center justify-center mt-[20px]">
              <li className="first:ml-0 ml-[15px]">
                <NavLink
                  activeClassName="active"
                  to="/home"
                  className="w-[26px] h-[26px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary"
                >
                  <svg
                    width="7"
                    height="12"
            ...
            <p className="text-sm md:hidden mt-[20px]">
              &copy;{' '}
              <NavLink
                activeClassName="active"
                to="/home"
