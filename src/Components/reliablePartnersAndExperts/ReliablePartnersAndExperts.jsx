...
const ReliablePartnersAndExperts = () => {
  return (
    <>
      ...
      <section className="team-section pb-[80px] lg:pb-[120px] overflow-hidden">
        <div className="container">
          <div className="grid grid-cols-12">
            <div className="col-span-12">
            ...
            <div className="text-center group mb-[30px]">
              <div className="relative rounded-[6px_6px_0px_0px]">
                <a
                  ...
                  className="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#F5F9F8] before:w-full before:h-[calc(100%_-_60px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]"
                >
                  <img
                    src={person1}
                    className="w-auto h-auto block mx-auto"
              ...
              <div className="bg-[#FFFDFC] z-[1] drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] rounded-[0px_0px_6px_6px] px-[15px] py-[20px] border-b-[6px] border-primary before:transition-all before:duration-300 group-hover:border-secondary relative before:absolute before:left-0 before:bottom-0 before:h-0 before:w-full before:bg-primary before:z-[-1] group-hover:before:h-full">
                <h3>
                  <a
                    href="agent-details.html"
                    className="font-lora font-normal text-base text-primary group-hover:text-white"
                  >
                    Albert S. Smith
                  </a>
                </h3>
                ...
                <ul className="inline-flex items-center justify-center absolute w-full top-[-15px] left-0 overflow-hidden">
                  ...
                  <li className="translate-y-[30px] group-hover:translate-y-[0] transition ease-in-out duration-500 delay-300 ml-[15px]">
                    <a
                      href="#"
                      aria-label="svg"
                      className="w-[26px] h-[26px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]"
                  ...
                  <li className="translate-y-[30px] group-hover:translate-y-[0] transition ease-in-out duration-700 delay-300 ml-[15px]">
                    <a
                      href="#"
                      aria-label="svg"
                      className="w-[26px] h-[26px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]"
...
export default ReliablePartnersAndExperts;
