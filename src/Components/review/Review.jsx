...
import person3 from '../../assets/images/testimonial/person3.png';

const Review = () => {
  return (
    <section
      className="testimonial-section md:pt-[50px] bg-no-repeat bg-white relative z-[5]"
      style={{
        backgroundImage: 'url("../../assets/images/testimonial/pattern.png")',
      }}
    >
      <div className="container testimonial-carousel-one">
        <div className="grid items-center grid-cols-12 gap-x-[30px] mb-[-30px]">
          <div className="col-span-12 lg:col-span-7 mb-[30px]">
            <div className="swiper -m-[30px] p-[30px]">
              <div className="swiper-wrapper">
                <div className="swiper-slide">
                  <div className="relative text-right">
                    <div className="inline-block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-primary text-primary before:w-full before:h-[calc(100%_-_50px)] before:z-[-1] before:rounded-[16px]">
                      <img
                        src={person1}
                        className="w-auto h-auto block mx-auto relative z-[2]"
                        loading="lazy"
                        width="300"
                        height="380"
                        alt="Oliver Stephen"
                      />
                      <img
                        className="absolute right-[20px] bottom-0 z-[1]"
                        src={shape}
                        width="130"
                        height="132"
                        loading="lazy"
                    ...
                    <div className="review-shadow-card text-left rounded-[14px] pl-[20px] sm:pl-[30px] pr-[45px] pt-[30px] sm:pt-[45px] pb-[20px] sm:pb-[30px]">
                      ...
                      <p className="text-primary">
                        Bary do a great job to find the perfect home. It’s very
                        easy for every one to buy, sell or rent property we
                        belive they continure their great service.
                      </p>
                      <ul>
          ...
          <div className="col-span-12 lg:col-span-5 mb-[30px] order-first lg:order-last">
            <div className="relative 2xl:ml-[55px] max-w-[385px]">
              <span className="text-secondary text-tiny capitalize inline-block mb-[10px]">
                Testimonial
              </span>
              <h2 className="font-lora text-primary text-[24px] sm:text-[30px] xl:text-xl mb-[20px] max-w-[375px] font-medium">
              ...
              <p>
                ...
                have to choose here and enjoy.{' '}
              </p>

              <div className="testimonial-pagination hidden sm:block">
                <div className="swiper-button-prev w-[36px] h-[36px] rounded-full bg-primary  text-white hover:bg-secondary top-auto bottom-[-65px] left-0"></div>
                <div className="swiper-button-next w-[36px] h-[36px] rounded-full bg-primary  text-white hover:bg-secondary top-auto bottom-[-65px] left-[56px]"></div>
              </div>
            </div>
          </div>
        </div>
